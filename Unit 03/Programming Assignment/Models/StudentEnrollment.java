...
/**
 * The StudentEnrollment class represents an enrollment of a student in a course, taught by a professor,
 * with a specific enrollment date and grade scale. It also includes methods to calculate the letter grade
...
public class StudentEnrollment extends Model {
    ...
    /**
     * Constructs a new StudentEnrollment with the specified student, course, professor, and enrollment date.
     *
    ...
    /**
     * Returns the unique ID of the enrollment, combining the student ID and course ID.
     *
    ...
    public String getLetterGrade() {
        ...
        if (this.gradeScale >= 98) return "A+";
        if (this.gradeScale >= 93) return "A";
        if (this.gradeScale >= 90) return "A-";
        if (this.gradeScale >= 88) return "B+";
        if (this.gradeScale >= 83) return "B";
        if (this.gradeScale >= 80) return "B-";
        if (this.gradeScale >= 78) return "C+";
        if (this.gradeScale >= 73) return "C";
        if (this.gradeScale >= 70) return "C-";
        if (this.gradeScale >= 68) return "D+";
        if (this.gradeScale >= 63) return "D";
        if (this.gradeScale >= 60) return "D-";
    ...
    /**
     * Returns a formatted string representing the enrollment details, including student name, course name,
     ...
     *
     * @param isIncludeStudent flag indicating whether to include the student's name in the header.
